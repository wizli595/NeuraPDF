...
<div 
	class="flex flex-col md:flex-row justify-between items-center gap-6 my-8"
...
>
	<div class="flex items-center gap-4">
		...
		>
			...
			<div class="relative w-12 h-12 flex items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-indigo-500 text-white shadow-lg">
				📄
			</div>
		</div>
		<h2 
